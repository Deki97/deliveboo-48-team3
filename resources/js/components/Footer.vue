<template>
    <footer>
        <div class="footer_wrapper">
            <div class="container">
                <div class="row row-cols-xs  row-cols-lg-3">
                    <div class="col my-3">
                        <!-- footer col -->
                        <div class="footer_col p-2 m-auto">
...
export default {
    ...
    data:function(){
        ...
        links:[
          {
            name:'Chi siamo',
            href:"http://127.0.0.1:8000/chi-siamo"
          },
          {
            name:'Lavora con noi',
            href:'http://127.0.0.1:8000/lavora-con-noi',
          },
          {
            name:'Ristoranti',
            href:'/#',
...
footer{
    color:$page_other_color;
        ...
        background: linear-gradient(0deg, rgba(0,1,3,1) 92%, rgba(243,129,50,1) 97%, rgba(124,9,2,1) 100%);
